...
def Unblock():
    ...
    with open (host_path, 'w') as f:
        ...
        if found_website:
            ...
            Label(window, text="Website not found", font='arial').place(x=350, y=200)
...
if not ctypes.windll.shell32.IsUserAnAdmin():
    # If not, prompt for running as administrator
    run_as_admin()
    sys.exit()

# Run the main event loop as an admin
window.mainloop()
